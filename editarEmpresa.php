                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-4">
                                            <input class="form-control" type="number" id="ruc" name="ruc" value="102654879800">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="razonSocial" class="col-4 col-form-label">Razón Social:</label>
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="razonSocial" name="razonSocial" value="GSDynamics">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="direccion" name="direccion" value="Av. Lima 417, Arequipa">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="dniContacto" name="dniContacto" value="46815198">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="nombreCompleto" class="col-4 col-form-label">Nombre Completo:</label>
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="nombreCompleto" name="nombreCompleto" value="Ignacio Rondon">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="telefonoContacto" class="col-4 col-form-label">Teléfono:</label>
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="telefonoContacto" name="telefonoContacto" value="992112752">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="correoContacto" class="col-4 col-form-label">Email:</label>
                                        <div class="col-8">
                                            <input class="form-control" type="text" id="correoContacto" name="correoContacto" value="ignacio.rondon@gsdynamics.com">
                                        </div>
                                    </div>
                                </div>
                            </div>
